...
print(f"Tamanhos brutos: Sessions={raw_shapes['sessions']}, Attempts={raw_shapes['attempts']}, Profile={raw_shapes['profile']}")

#limpeza de dados e diagnostico
cleaning_log = {}

#limpeza de sessoes/padrao de device
...
#limpeza da tabela de tentativas
df_attempts = df_attempts_raw.copy()
#mantem tentativas de 1 a 6
...
print("Limpeza concluída. Resumo exportado.")
...
#testes qui-quadrado
#played_next_day x newsletter_open_before_game
...
#active_d30 x newsletter_open_before_game
...
#metricas por hora x horario tipico de jogo
...
#jogo por hora e tipo de assinante
...
#5-11: manhã, 12-17: tarde, 18-23: noite, 0-4: madrugada
...
#periodo real de jogo x periodo declarado pelo usuario
...
#ordena por taxa de vitoria crescente (mais dificeis primeiro)
...
#analise demografica (idade, salario, cargo, setor, estado)
demographics_data = {}
...
for col in ['age_range', 'salary_range', 'sector', 'company_size', 'state']:
    ...
    #qui-quadrado: active_d30 vs variavel demografica
...
#qui-quadrado: pedido de delivery vs retencao D30
...
#teste t para variaveis num vs played_next_day e active_d30
...
print("Pipeline finalizado. Arquivos JSON exportados para:", data_dir)
